 ...
 */
export interface StatusLineToolInput {
 ...
 */
export class StatusLineTool implements MCPTool<StatusLineToolInput, BaseToolResult> {
  constructor(private configManager: ConfigurationManager) {}

  async execute(input: StatusLineToolInput): Promise<BaseToolResult> {
    try {
      ...
      return createErrorResult(error, 'StatusLineTool');
    }
  }
}
